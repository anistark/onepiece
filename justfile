...
components := "player terrain room house hut wall floor roof door window staircase stool table tent chair counter clock compass sign signpost lamp rug shelf bookshelf lake ocean shore sailboat fountain rocks cliff sky clouds grass trees bush flowers hedge lightrig fence flag bridge dock arch pillar well windmill path road bench bed crate barrel plant campfire birds"
